...
struct AppCopy {
    ...
    private let english: [CopyKey: String] = [
        ...
        .buyUnlimitedPrice: "One-time · $4.99", .buyUnlimitedDesc: "One-time purchase — removes ads and time limits forever.",
    ...
    private let russian: [CopyKey: String] = [
        ...
        .buyUnlimitedPrice: "Разовая · $4.99", .buyUnlimitedDesc: "Разовая покупка — навсегда убирает рекламу и лимиты времени.",
    ...
    private let chinese: [CopyKey: String] = [
        .vpnProtocol: "VPN 协议", .ssh2Recommended: "推荐使用 SSH2，它为您的 VPN 隧道提供最佳安全性。", .ssh2Desc: "带隧道的 Secure Shell v2", .useCustomDNS: "使用自定义 DNS", .primaryDNS: "主 DNS", .secondaryDNS: "备用 DNS", .customDNSHint: "自定义 DNS 服务器在 VPN 隧道处于活动状态时使用。", .connectionSection: "连接", .killSwitch: "断网保护", .killSwitchDesc: "VPN 断开时阻止流量", .connectOnDemand: "按需连接", .connectOnDemandDesc: "访问互联网时自动连接", .debugSection: "调试", .enableLogging: "启用日志记录", .enableLoggingDesc: "记录连接事件以供诊断", .freeTimeLeft: "剩余时间", .watchAdPlus3h: "+3小时免费", .unlimitedBadge: "不限量", .buyUnlimited: "获取不限量", .buyUnlimitedPrice: "一次性 · $4.99", .buyUnlimitedDesc: "一次性购买，永久去除广告和时间限制。", .restorePurchase: "恢复购买", .purchasing: "正在购买…", .restoreError: "无法恢复。请重试或登录 App Store。", .purchaseUnavailable: "当前无法购买。", .purchaseOwned: "您已拥有不限量。",
            .documentation: "文档",
    ...
    private let polish: [CopyKey: String] = [
        .vpnProtocol: "Protokół VPN", .ssh2Recommended: "Zalecany jest SSH2. Zapewnia najlepsze bezpieczeństwo Twojego tunelu VPN.", .ssh2Desc: "Secure Shell v2 z tunelem", .useCustomDNS: "Użyj własnego DNS", .primaryDNS: "DNS główny", .secondaryDNS: "DNS zapasowy", .customDNSHint: "Własne serwery DNS są używane, gdy tunel VPN jest aktywny.", .connectionSection: "Połączenie", .killSwitch: "Kill Switch", .killSwitchDesc: "Blokuj ruch po rozłączeniu VPN", .connectOnDemand: "Łącz na żądanie", .connectOnDemandDesc: "Łącz automatycznie przy dostępie do internetu", .debugSection: "Debugowanie", .enableLogging: "Włącz logowanie", .enableLoggingDesc: "Zapisuj zdarzenia połączenia do diagnostyki", .freeTimeLeft: "POZOSTAŁO", .watchAdPlus3h: "+3h za darmo", .unlimitedBadge: "BEZ LIMITÓW", .buyUnlimited: "Kup bez limitów", .buyUnlimitedPrice: "Jednorazowo · $4.99", .buyUnlimitedDesc: "Jednorazowy zakup — na zawsze usuwa reklamy i limity czasu.", .restorePurchase: "Przywróć zakup", .purchasing: "Kupowanie…", .restoreError: "Nie udało się przywrócić. Spróbuj ponownie lub zaloguj się do App Store.", .purchaseUnavailable: "Zakupy są teraz niedostępne.", .purchaseOwned: "Masz już pakiet bez limitów.",
