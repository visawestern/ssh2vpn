...
struct AppCopy {
    ...
    private let english: [CopyKey: String] = [
        ...
        .promoFallbackHeadline: "No ads right now — but this can be forever",
    ...
    private let german: [CopyKey: String] = [
        ...
        .promoFallbackHeadline: "Gerade keine Werbung — aber das kann für immer sein",
    ...
    private let french: [CopyKey: String] = [
        ...
        .promoFallbackHeadline: "Pas de pub pour le moment — mais ce peut être pour toujours",
    ...
    private let dutch: [CopyKey: String] = [
        ...
        .promoFallbackSub: "Scheer jezelf van wachttijd en reclame",
