    ...
    private var headerView: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 8) {
                ...
                // Copy button (MAC-fork: NSPasteboard вместо UIPasteboard)
                Button {
...
// MARK: - MAC-fork: NSSharingServicePicker bridge (вместо UIActivityViewController)
                ...
                HStack {
                    ...
                    Button("Share…") {
                        ...
                        NSSharingServicePicker(items: [url])
                            .show(relativeTo: contentView.bounds, of: contentView, preferredEdge: .minY)
                    }
