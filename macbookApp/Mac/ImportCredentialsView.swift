...
// MAC-fork Iphone/App/ImportCredentialsView.swift: iOS-only SwiftUI API
// (navigationBarTitleDisplayMode, topBar* placements, presentationDetents,
// textInputAutocapitalization) заменены/убраны. Логика та же.
